...
df = pd.read_csv("hd_glm_tp_truerad_supp.csv", header=None)
df = np.array(df)
...
gen_plt_hd_rel(cov[:, :, :, :, 0, :, :, :], rel_rad[:, :, :, :, 0, :, :, :], ks, km, 'glm', 'tp', 'hd', 'a')
gen_plt_hd_rel(cov[:, :, :, :, 1, :, :, :], rel_rad[:, :, :, :, 1, :, :, :], ks, km, 'glm', 'tp', 'hd', 's')
gen_plt_hd_rel(cov[:, :, :, :, 2, :, :, :], rel_rad[:, :, :, :, 2, :, :, :], ks, km, 'glm', 'tp', 'hd', 'n')
