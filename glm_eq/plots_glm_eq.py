...
df = pd.read_csv("hd_glm_eq_truerad_supp.csv", header=None)
df = np.array(df)
...
gen_plt_hd_rel(cov[:, :, :, :, 0, :, :, :], rel_rad[:, :, :, :, 0, :, :, :], ks, km, 'glm', 'eq', 'hd', 'a')
gen_plt_hd_rel(cov[:, :, :, :, 1, :, :, :], rel_rad[:, :, :, :, 1, :, :, :], ks, km, 'glm', 'eq', 'hd', 's')
gen_plt_hd_rel(cov[:, :, :, :, 2, :, :, :], rel_rad[:, :, :, :, 2, :, :, :], ks, km, 'glm', 'eq', 'hd', 'n')
